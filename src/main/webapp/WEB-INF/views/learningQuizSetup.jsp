...
<t:page pageTitle="learning_quiz_setup">
    ...
    <jsp:body>
        ...
        <script>
            var LearningQuizSetup = (function() {
        ...
        <form method="POST" action="/learning/quiz/start" id="startLearningForm">
        ...
        <div class="panel panel-primary" style="width: auto;margin-top: 25px;">
            ...
            <div class="light-font">
                <ol class="breadcrumb primary-color">
                    ...
                    <li class="breadcrumb-item active"><spring:message code="learning_quiz_setup" /></li>
                </ol>
            </div>
                ...
                <div class="card-body">
                    ...
                    <c:if test="${not empty categories}">
                        ...
                        <div class="d-flex" style="justify-content: flex-end;margin-top: 15px;">
                            <button class="btn btn-primary" onclick="LearningQuizSetup.start();">
